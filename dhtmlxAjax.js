...
dhtmlDragAndDropObject.prototype.preCreateDragCopy=function(e){
	...
	var ee=(e||event);
	window.dhtmlDragAndDrop.old_event = [ee.clientX,ee.clientY];
...
dhtmlDragAndDropObject.prototype.callDrag=function(e){
	...
	if (!dragger.dragNode&&dragger.waitDrag){
		var oe = window.dhtmlDragAndDrop.old_event;
		var ee = e||event;
		if (Math.abs(oe[0]-ee.clientX)+Math.abs(oe[1]-ee.clientY) < 2 ) return;
